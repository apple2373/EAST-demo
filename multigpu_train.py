...
tf.app.flags.DEFINE_integer('lr_step', 5000, '')
...
def main(argv=None):
    ...
    learning_rate = tf.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=FLAGS.lr_step , decay_rate=FLAGS.lr_decay, staircase=True)
